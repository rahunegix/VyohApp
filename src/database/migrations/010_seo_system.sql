...
(
  ...
  'Saathini is Uttarakhand''s verified matrimony and dating platform for Garhwali & Kumaoni singles. Phone-verified profiles, family-friendly Hindu marriage paths, and a trusted alternative to Maangal Platform and Shaadi.com.',
  'uttarakhand matrimony, garhwali matrimony, kumaoni matrimony, pahadi matrimonial site, alternative to Maangal Platform, alternative to shadi.com, uttarakhand dating, hindu marriage uttarakhand',
  ...
  '[
    ...
    {"question":"How is Saathini different from Pahadi Maangal Platform or Shaadi Platform?","answer":"Saathini focuses on Uttarakhand — Garhwali and Kumaoni communities, verified profiles, and culturally aware matching rather than a generic all-India catalogue."},
  ...
  ARRAY['uttarakhand matrimony','garhwali matrimony','kumaoni matrimony','alternative to Maangal Platform','alternative to shadi.com','pahadi matrimonial site'],
  '[{"label":"Garhwali matrimony","href":"/matrimony/garhwali-matrimony"},{"label":"Kumaoni matrimony","href":"/matrimony/kumaoni-matrimony"},{"label":"Alternative to Maangal Platform","href":"/matrimony/alternative-maangal-com"},{"label":"Success stories","href":"/success-stories"}]'::jsonb,
  TRUE,
  0
),
(
...
(
  ...
  'Looking for an alternative to Maangal Platform? Saathini offers verified Uttarakhand matrimony with Garhwali & Kumaoni focus, modern UX, and trust-first matching.',
  'alternative to Maangal Platform, Maangal Platform alternative, uttarakhand matrimony site',
  'A trusted alternative to Maangal Platform for Uttarakhand',
  'Local focus · Verified profiles · Garhwali & Kumaoni communities',
  '<p>If you searched for an alternative to Maangal Platform, Saathini provides a modern, mobile-first matrimony experience focused on Uttarakhand — not a generic national listing site.</p>',
  '[{"title":"Why users switch from Maangal Platform","body":"Families often want better verification, mobile apps, and region-specific discovery.","bullets":["OTP-verified phone numbers","Face verification badges","AI compatibility for Pahadi values","Active success stories from Uttarakhand"]}]'::jsonb,
  '[{"question":"Is Saathini affiliated with Maangal Platform?","answer":"No. Saathini is an independent platform by FirstTrek OPC Private Limited."}]'::jsonb,
  ARRAY['alternative to Maangal Platform','Maangal Platform alternative'],
...
(
  ...
  '[{"label":"Alternative to Maangal Platform","href":"/matrimony/alternative-maangal-com"}]'::jsonb,
  TRUE,
  21
),
(
