      ...
      <div className="relative flex h-dvh min-h-0 flex-1 flex-col overflow-hidden">
        <div className="absolute inset-0 z-0 lg:hidden">
          <div className="absolute inset-0">
            <Image
              src={WELCOME_SUCCESS_STORIES[0].src}
              alt=""
              fill
              priority
        ...
        <div className="relative z-10 flex min-h-0 flex-1 flex-col overflow-hidden lg:bg-white lg:text-foreground">
          ...
          >
            <SuccessStoryShowcase stories={WELCOME_SUCCESS_STORIES} theme="dark" compact />
          </motion.div>
          ...
          >
            <SuccessStoryShowcase stories={WELCOME_SUCCESS_STORIES} theme="light" />
          </motion.div>
