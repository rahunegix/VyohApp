...
import { FadeIn, StaggerChildren, StaggerItem } from "@/components/common/page-transition";
...
// Mock dropdown for More options since we don't have a Dropdown component immediately available
...
export default function MatchDetailsPage() {
  ...
  const profile = findDiscoverProfile(params.id as string);
  ...
  if (!profile) {
    return (
      <div className="flex h-screen flex-col items-center justify-center">
        <PageHeader showBack title="Profile Not Found" />
        <p className="mt-8 text-center text-muted-foreground">This profile may have been removed or hidden.</p>
  ...
  return (
    <div className="pb-24 bg-muted/20 min-h-screen relative">
      ...
      <StaggerChildren className="px-5 mt-4 space-y-5">
        ...
        {/* Detailed Info Tabs (Personal / Family) */}
        <StaggerItem>
          <ProfileTabs
            bio={profile.bio}
            city={profile.city}
